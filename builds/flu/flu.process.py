...
from flu_titers import HI_model, HI_export, HI_seq_diff_and_titers_export, HI_aa_diff_and_titers_export, H3N2_scores, seasonal_flu_scores
...
if __name__=="__main__":
    ...
    if runner.config["build_tree"]:
        ...
        if hasattr(runner, "titers"):
            HI_model(runner)
            HI_seq_diff_and_titers_export(runner)
            HI_aa_diff_and_titers_export(runner)
            if runner.info["lineage"] == "h3n2":
